...
NS1="NS1"
NS2="NS2"
NODE_IP="192.168.0.128"
BRIDGE_SUBNET="172.16.0.0/24"
BRIDGE_IP="172.16.0.1"
IP1="172.16.0.2"
IP2="172.16.0.3"
TO_NODE_IP="192.168.0.129"
...
echo "Creating the Veth pairs to the namespaces"
sudo ip link add veth10 type veth peer name veth11
sudo ip link add veth20 type veth peer name veth21
    #ip link show type veth

echo "Adding the veth pairs to their namespaces"
sudo ip link set veth11 netns $NS1
sudo ip link set veth21 netns $NS2

echo "Configuring the interfaces in the namespaces with IP addresses"
sudo ip netns exec $NS1 ip addr add $IP1/24 dev veth11
sudo ip netns exec $NS2 ip addr add $IP2/24 dev veth21

echo "Enabling the interaces inside the namespace"
...
sudo ip netns exec $NS1 ping -W 1 -c 2 192.168.0.129
